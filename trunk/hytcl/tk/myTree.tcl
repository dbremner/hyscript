...
pack .c.l -expand 1
foreach z {1 2 3} {
  Tree:newitem .w /dir$z -image idir
  foreach x {1 2 3 4 5 6} {
    Tree:newitem .w /dir$z/file$x -image ifile
  }
  Tree:newitem .w /dir$z/subdir -image idir
  foreach y {1 2} {
    Tree:newitem .w /dir$z/subdir/file$y -image ifile
  }
  foreach zz {1 2 3 4} {
    Tree:newitem .w /dir$z/subdir/ssdir$zz -image idir
    Tree:newitem .w /dir$z/subdir/ssdir$zz/file1  ;# No icon!
    Tree:newitem .w /dir$z/subdir/ssdir$zz/file2 -image ifile
  }
}
.w bind x <1> {
